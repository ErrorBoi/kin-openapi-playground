...
[![Go Report Card](https://goreportcard.com/badge/github.com/errorboi/kin-openapi)](https://goreportcard.com/report/github.com/errorboi/kin-openapi)
[![GoDoc](https://godoc.org/github.com/errorboi/kin-openapi?status.svg)](https://godoc.org/github.com/errorboi/kin-openapi)
...
Here's some projects that depend on _kin-openapi_:
  ...
  * (Feel free to add your project by [creating an issue](https://github.com/errorboi/kin-openapi/issues/new) or a pull request)
...
# Structure
  * _openapi2_ ([godoc](https://godoc.org/github.com/errorboi/kin-openapi/openapi2))
    * Support for OpenAPI 2 files, including serialization, deserialization, and validation.
  * _openapi2conv_ ([godoc](https://godoc.org/github.com/errorboi/kin-openapi/openapi2conv))
    * Converts OpenAPI 2 files into OpenAPI 3 files.
  * _openapi3_ ([godoc](https://godoc.org/github.com/errorboi/kin-openapi/openapi3))
    * Support for OpenAPI 3 files, including serialization, deserialization, and validation.
  * _openapi3filter_ ([godoc](https://godoc.org/github.com/errorboi/kin-openapi/openapi3filter))
    * Validates HTTP requests and responses
  * _openapi3gen_ ([godoc](https://godoc.org/github.com/errorboi/kin-openapi/openapi3gen))
    * Generates `*openapi3.Schema` values for Go types.
  * _pathpattern_ ([godoc](https://godoc.org/github.com/errorboi/kin-openapi/pathpattern))
